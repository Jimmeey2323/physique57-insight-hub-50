...
import { LateCancellationsSection } from '@/components/dashboard/LateCancellationsSection';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50/30 to-pink-50/20">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-red-900 via-red-800 to-red-700 text-white">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-20 right-10 w-24 h-24 bg-red-300/20 rounded-full animate-bounce delay-1000"></div>
        ...
        <div className="relative px-8 py-12">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center space-y-4">
              ...
              <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-white via-red-100 to-red-100 bg-clip-text text-transparent animate-fade-in-up delay-200">
                Late Cancellations
              </h1>
              
              <p className="text-xl text-red-100 max-w-2xl mx-auto leading-relaxed animate-fade-in-up delay-300">
      ...
      <div className="relative">
        <div className="container mx-auto px-6 py-8">
          <LateCancellationsSection data={lateCancellationsData} />
        </div>
      </div>
